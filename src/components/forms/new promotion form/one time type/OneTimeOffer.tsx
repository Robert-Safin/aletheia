...
import styles from "./OnetimeOffer.module.css";
...
export interface OneTimeOfferForm {
  name: string;
  details: string;
  monday: boolean;
  tuesday: boolean;
...
const OnetimeOffer:FC<Props> = (props) => {
  ...
  const handleSubmit = async (e:FormEvent) => {
    ...
    if (startDateRefObj.getHours() === endDateRefObj.getHours()) {
    ...
    props.submitRecurringOfferForm(form)
  }
